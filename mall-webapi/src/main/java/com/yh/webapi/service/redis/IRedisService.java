package com.yh.webapi.service.redis;
...
public interface IRedisService<K, V> {
     ...
     * @return 之前的签到状态
     */
    Boolean doSign(String userKey, LocalDate date);
     ...
     * @return 当前的签到状态
     */
    Boolean checkSign(String userKey, LocalDate date);
     ...
     * @return 当前的签到次数
     */
     Long getSignCount(String userKey, LocalDate date);
     ...
     * @return 当月连续签到次数
     */
     Long getContinuousSignCount(String userKey, LocalDate date);
     ...
     * @return 用户签到日历
     */
     Map<String,Boolean> getSignInfo(String userKey,LocalDate date);
}
